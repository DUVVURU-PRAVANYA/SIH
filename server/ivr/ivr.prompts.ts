...
export const PROMPTS_TA: PromptSet = {
  ...
  languageSelect: 'அரசு தலைமை மருத்துவமனைக்கு நல்வரவு. தமிழுக்கு எண் இரண்டை அழுத்தவும்.',
  mainMenu: 'புதிய டோக்கன் பெற எண் ஒன்றை அழுத்தவும். உங்கள் டோக்கன் நிலையை அறிய எண் இரண்டை அழுத்தவும். உங்கள் டோக்கனை மீண்டும் கேட்க எண் மூன்றை அழுத்தவும்.',
  deptMenu: 'பொது மருத்துவத்திற்கு எண் ஒன்றை அழுத்தவும். இதயவியலுக்கு எண் இரண்டை அழுத்தவும். எலும்பியல் பிரிவுக்கு எண் மூன்றை அழுத்தவும். தோல் மருத்துவத்திற்கு எண் நான்கை அழுத்தவும். பிரிவை தேர்வு செய்ய உதவி பெற எண் ஐந்தை அழுத்தவும்.',
  symptomPrompt: 'தயவுசெய்து உங்கள் உடல்நலப் பிரச்சனையை சுருக்கமாகக் கூறுங்கள்.',
  symptomResult: (deptName: string) => `உங்கள் அறிகுறிகளின்படி, ${deptName} பரிந்துரைக்கப்படுகிறது. உறுதிப்படுத்த எண் ஒன்றை அழுத்தவும்.`,
  confirmDept: (deptName: string) => `நீங்கள் ${deptName} தேர்ந்தெடுத்துள்ளீர்கள். உறுதிப்படுத்த எண் ஒன்றை அழுத்தவும்.`,
  tokenGenerated: (token: string, peopleAhead: number, waitMinutes: number, doctorName?: string) =>
  ...
  consultationCompleted: (token: string, diagnosis?: string) =>
    diagnosis
      ? `உங்கள் டோக்கன் எண் ${token} மருத்துவர் ஆலோசனை முடிவடைந்தது. பரிசோதனை முடிவு: ${diagnosis}. உங்கள் வருகை நிறைவு பெற்றது.`
      : `உங்கள் டோக்கன் எண் ${token} மருத்துவர் ஆலோசனை முடிவடைந்தது. உங்கள் வருகை நிறைவு பெற்றது.`,
  routedToPharmacy: (token: string, peopleAhead: number, waitMinutes: number) =>
  ...
  calledForConsultation: (token: string) =>
    `உங்கள் டோக்கன் எண் ${token} முறை வந்துவிட்டது. மருத்துவர் ஆலோசனைக்கு அழைக்கப்பட்டுள்ளீர்கள்.`,
  ...
  callEnded: 'அரசு தலைமை மருத்துவமனை சேவையை அழைத்தமைக்கு நன்றி. அழைப்பு முடிந்தது.',
};
